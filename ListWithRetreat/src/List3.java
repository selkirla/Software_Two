...
public class List3<T> extends ListSecondary<T> {
    ...
    public final T removeRightFront() {
        ...
        returned.next.previous = this.lastLeft;
        this.rightLength--;
    ...
    public final void advance() {
        ...
        //move lastLeft pointer one node up
    ...
    public final void moveToFinish() {
        //move lastLeft pointer one node before postFinish
    ...
    public final void retreat() {
        ...
        //move lastLeft pointer one node back
