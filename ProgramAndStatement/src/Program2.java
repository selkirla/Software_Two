...
public class Program2 extends ProgramSecondary {
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        //swap contexts between program & given map c
        Map<String, Statement> tempContext = new Map1L<>();
    ...
    public final Statement newBody() {
        //create new instance of body Statement & return it
    ...
    public final void swapBody(Statement b) {
        ...
        //swap bodies between program & provided statement b
